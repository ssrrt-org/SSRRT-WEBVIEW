...
export default function AdminBrandingPage() {
  ...
  const set = (key) => (value) => patch({ branding: { ...branding, [key]: value } });

  return (
    <div>
      <header className="admin-page-head">
        <h1>Logos & brand</h1>
        <p>Header Devi mark, Sri Yantra, footer mark, and the Trust title that sit above the public navigation.</p>
      </header>
